...
name: deploy
description: >-
  Load this skill when shipping a release to a running environment: building and tagging Docker
  images, promoting through staging to production, running post-deploy health and metric checks, or
