# ceh-scenario-webapp-greenfield

CEH scenario bundle: starting a web frontend from nothing — everything in the -iterate bundle plus planning and scaffolding.
...
```
/plugin install ceh-scenario-webapp-greenfield@ceh-plugins --scope user
```
