...
description: >-
  Evaluate a Claude Code skill or plugin you just wrote or changed, to find out whether it is any
  good before you ship it. Reads the target, derives per-target success criteria, runs an
