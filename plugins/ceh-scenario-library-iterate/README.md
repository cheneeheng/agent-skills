...
CEH scenario bundle: working on a Python library that already ships — features, fixes, tests, docs, releases.
...
```
/plugin install ceh-scenario-library-iterate@ceh-plugins --scope user
```
