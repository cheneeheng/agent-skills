...
CEH scenario bundle: working on a web frontend that already ships — features, fixes, tests, docs, releases.
...
```
/plugin install ceh-scenario-webapp-iterate@ceh-plugins --scope user
```
