# ceh-scenario-library-greenfield

CEH scenario bundle: starting a Python library from nothing — everything in the -iterate bundle plus planning and scaffolding.
...
```
/plugin install ceh-scenario-library-greenfield@ceh-plugins --scope user
```
