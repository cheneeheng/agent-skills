...
def run_loop(
    ...
    for iteration in range(1, max_iterations + 1):
        ...
        if live_report_path:
            ...
            # Patch: explicit utf-8 on every read/write in this file. The stock calls use
            # the locale encoding, which is cp1252 on Windows: it silently mangles any
            # non-ASCII character on read, and raises UnicodeEncodeError on write for
            # one it lacks.
