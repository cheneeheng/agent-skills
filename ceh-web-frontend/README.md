...
| Design System | `/ceh-web-frontend:design-system` | Giving a frontend its visual design — choosing a look/feel, theme, or brand from bundled token-driven templates (Meridian, Tidewater) |
