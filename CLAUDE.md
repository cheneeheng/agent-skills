...
| `ceh-workflow-builder` | Turning a repetitive multi-step task into a runnable artifact: the interview, the one-skill-vs-workflow gate, the step-earns-a-skill test, data-contract schemas for step-to-step handoffs, and leaf-first emission into the target repo's `.claude/skills/` |
